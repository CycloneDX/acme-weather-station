...
#TODO when the CLI tool supports converting to protobuf format
#TODO 1. remove the tracked boms/bom-1.3.bin file
#TODO 2. uncomment the following line
#docker run --volume "$(pwd)":/files cyclonedx/cyclonedx-cli convert --input-file /files/bom-1.3.json --output-format=protobuf_v1_3 > boms/bom-1.3.bin
